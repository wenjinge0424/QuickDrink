//
//  BusinessRegistPhotoController.m
//  quickdrinks
//
...
#import "BusinessRegistPhotoController.h"
#import "Util.h"
#import "DBCong.h"

@interface BusinessRegistPhotoController ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
...
@implementation BusinessRegistPhotoController
...
- (IBAction)onNext:(id)sender {
    ...
    if(!m_selectedImage){
        ...
        [DBUsers addPhotoInfoTo:[[StackMemory createInstance] stack_signInItem] :imageData sucessBlock:^(id returnItem, NSError * error){
            ...
            [self performSegueWithIdentifier:@"showPaymentInformationForSignUp" sender:self];
