//
//  BusinessAddDrinkType5Controller.m
//  quickdrinks
//
//  Created by mojado on 6/21/17.
...
@interface BusinessAddDrinkType5Controller ()<UITextFieldDelegate, UITextViewDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate, CustomComboBox_SelectedItem>
{
    int animationHeight;
...
@implementation BusinessAddDrinkType5Controller
...
- (void)viewDidLoad {
    ...
    selected_index = 0;
    self.combo_catgory.lbl_title.text = @"Chardonnay";
    self.combo_catgory.m_containDatas = [[NSMutableArray alloc] initWithObjects:@"Chardonnay", @"Riesling", @"Pinot Gris" , @"Sauvignon Blanc", @"Merlot", @"Cabernet Sauvignon", @"Pinot Noir", @"Shiraz", @"Sangiovese", @"Nebbiolo", @"Malbec", @"Tempranillo", @"Gamay", @"Zinfandel",nil];
...
- (void) setEditMode
{
    ...
    [self.checkerGroup setSelectItem:currentItem.row_subcategory_id];
    self.combo_catgory.lbl_title.text = [self.combo_catgory.m_containDatas objectAtIndex:currentItem.row_selected_type];
    selected_index = currentItem.row_selected_type;
...
- (IBAction)onCheck:(id)sender {
    ...
    [self onDone:^{
        ...
        if(!self.isEditMode){
            ...
            item.row_category_id = 3;
            item.row_subcategory_id = selectedIndex;
            ...
            currentItem.row_category_id = 3;
            currentItem.row_subcategory_id = selectedIndex;
...
{
    NSMutableArray *  array = self.combo_catgory.m_containDatas;
...
{
    selected_index = [self getIndexFromStringArrayforString:item];
}
