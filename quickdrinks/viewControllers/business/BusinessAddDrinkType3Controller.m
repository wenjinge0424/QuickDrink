//
//  BusinessAddDrinkType3Controller.m
//  quickdrinks
//
...
@interface BusinessAddDrinkType3Controller ()<UITextFieldDelegate, UITextViewDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate,CustomComboBox_SelectedItem>
{
    int animationHeight;
...
@property (strong, nonatomic) IBOutlet CustomComboBox *combo_category;
...
@implementation BusinessAddDrinkType3Controller
...
- (void)viewDidLoad {
    ...
    selected_index = 0;
    self.combo_category.lbl_title.text = @"Vodka";
    self.combo_category.m_containDatas = [[NSMutableArray alloc] initWithObjects:@"Vodka", @"Bourbon", @"Rum", @"Whiskey", @"Tequila", @"Wine",nil];
    self.combo_category.delegate = self;
...
- (void) setEditMode
{
    ...
    self.combo_category.lbl_title.text = [self.combo_category.m_containDatas objectAtIndex:currentItem.row_selected_type];
    self.edt_instruction.text = currentItem.row_instruction;
...
- (IBAction)onCheck:(id)sender {
    ...
    [self onDone:^{
        ...
        if(!self.isEditMode){
            ...
            item.row_category_id = 4;
            item.row_subcategory_id = 0;
            item.row_selected_type = selected_index;
           ...
           /* }];*/
            ...
            currentItem.row_category_id = 4;
            currentItem.row_subcategory_id = 0;
            currentItem.row_selected_type = selected_index;
...
{
    selected_index = [self getIndexFromStringArrayforString:item :self.combo_category];
}
