//
//  BusinessAddDrinkType1Controller.m
//  quickdrinks
//
...
@interface BusinessAddDrinkType1Controller ()<UITextFieldDelegate, UITextViewDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
    int animationHeight;
...
@implementation BusinessAddDrinkType1Controller
...
- (void) setEditMode
{
    ...
    [self.checkerGroup setSelectItem:currentItem.row_selected_type];
...
- (IBAction)onOutStock:(id)sender {
    ...
    [DrinkItem setTemprarilyState:vlaue :currentItem sucessBlock:^(id value, NSError * error){
        currentItem.row_isTemporarily = vlaue;
